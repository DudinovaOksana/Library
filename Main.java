public class Main {
    public static void main(String[] args) {
        ...
        lib.bookList.add(new Book("Приключения Тома Соера","М.Твен",1991,1234,"Отдел иностранной литературы", "Художественная литература"));
        ...
        Fiction fiction = new Fiction("Цвет волшебства","Т.Пратчер",1998,2345,"Художественная литература","Абонемент");
        System.out.println(fiction);
        ForeignLiterature fore = new ForeignLiterature();
